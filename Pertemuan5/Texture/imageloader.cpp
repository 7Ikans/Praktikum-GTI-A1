...
namespace {
    // Konversi 4 buah karakter ke integer (little-endian)
    ...
    // Konversi 2 buah karakter ke integer (little-endian)
    ...
    public:
        ...
        auto_array(const auto_array<T> &aarray) {
            ...
            const_cast<auto_array<T>&>(aarray).isReleased = true;
        }
        ...
        // PERBAIKAN: Mengembalikan T* bukan T
        T* release() {
            isReleased = true;
            return array;
        }
